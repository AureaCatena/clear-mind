...
const TherapistProfile = () => {
    ...
    const { tToken, profileData, setProfileData, getProfileData, backendUrl } = useContext(TherapistContext)
    ...
    const updateProfile = async () => {
     try {
        ...
        const { data } = await axios.post(backendUrl + '/api/therapist/update-profile', updateData, {headers: {tToken}})
