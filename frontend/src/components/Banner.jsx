...
const Banner = () => {
  ...
  return (
    <div className='flex bg-primary rounded-lg px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
        ...
        {/* ---= Right side ---- */}
        <div className='hidden md:block relative md:w-[220px] lg:w-[240px]'>
            <img className='absolute bottom-0 right-6 w-full max-w-[220px] lg:max-w-[280px] object-contain' src={assets.appointment_img} alt="" />
        </div>
    </div>
  )
}
